...
export const JOBS: Job[] = [
    {
        id: 1, title: 'Senior AI Researcher', company: 'Quantum Leap', location: 'Palo Alto', salary: '$190k–$260k', type: 'Full-Time', industry: 'Engineering', exp: 'Senior', logo: 'QL', color: '#0D47A1', match: 96, posted: '1 day ago', country: 'USA',
    ...
    {
        id: 2, title: 'Product Designer', company: 'VividOps', location: 'Remote', salary: '$130k–$170k', type: 'Full-Time', industry: 'Design', exp: 'Mid', logo: 'VO', color: '#1565C0', match: 91, posted: '2 days ago', country: 'USA',
    ...
    {
        id: 3, title: 'Blockchain Architect', company: 'DefiCore', location: 'Singapore', salary: '$150k–$210k', type: 'Contract', industry: 'Engineering', exp: 'Senior', logo: 'DC', color: '#1E88E5', match: 88, posted: '3 days ago', country: 'USA',
    ...
    {
        id: 4, title: 'Growth Engineer', company: 'ScaleUp', location: 'New York', salary: '$140k–$185k', type: 'Full-Time', industry: 'Marketing', exp: 'Mid', logo: 'SU', color: '#2196F3', match: 84, posted: '4 days ago', country: 'USA',
    ...
    {
        id: 5, title: 'ML Infrastructure Lead', company: 'DataFlux', location: 'Berlin', salary: '$110k–$160k', type: 'Full-Time', industry: 'Engineering', exp: 'Lead', logo: 'DF', color: '#42A5F5', match: 79, posted: '5 days ago', country: 'USA',
    ...
    {
        id: 6, title: 'Head of Product', company: 'Aether', location: 'London', salary: '$180k–$230k', type: 'Full-Time', industry: 'Product', exp: 'Lead', logo: 'AE', color: '#0D47A1', match: 93, posted: '1 day ago', country: 'USA',
    ...
    {
        id: 7, title: 'Finance Manager', company: 'CapitalNow', location: 'Remote', salary: '$100k–$140k', type: 'Full-Time', industry: 'Finance', exp: 'Senior', logo: 'CN', color: '#1565C0', match: 77, posted: '6 days ago', country: 'USA',
    ...
    {
        id: 8, title: 'UX Research Lead', company: 'Designify', location: 'Austin', salary: '$120k–$155k', type: 'Part-Time', industry: 'Design', exp: 'Senior', logo: 'DZ', color: '#1E88E5', match: 82, posted: '2 days ago', country: 'USA',
    ...
    {
        id: 9, title: 'DevOps Engineer', company: 'CloudNine', location: 'Remote', salary: '$130k–$170k', type: 'Remote', industry: 'Engineering', exp: 'Mid', logo: 'C9', color: '#2196F3', match: 87, posted: '1 day ago', country: 'USA',
    ...
    {
        id: 10, title: 'Marketing Strategist', company: 'GrowthLab', location: 'Chicago', salary: '$90k–$120k', type: 'Full-Time', industry: 'Marketing', exp: 'Entry', logo: 'GL', color: '#42A5F5', match: 72, posted: '7 days ago', country: 'USA',
    ...
    {
        id: 11, title: 'HR Business Partner', company: 'PeopleFirst', location: 'Toronto', salary: '$85k–$115k', type: 'Full-Time', industry: 'HR', exp: 'Mid', logo: 'PF', color: '#0D47A1', match: 68, posted: '5 days ago', country: 'USA',
    ...
    {
        id: 12, title: 'Data Analyst', company: 'InsightCo', location: 'Remote', salary: '$80k–$110k', type: 'Full-Time', industry: 'Finance', exp: 'Entry', logo: 'IC', color: '#1565C0', match: 75, posted: '3 days ago', country: 'USA',
