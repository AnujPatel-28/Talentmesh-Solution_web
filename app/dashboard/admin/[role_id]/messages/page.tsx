                ...
                {selectedConvoId && selectedConvo ? (
                    <>
                        <div className={styles.panelSection}>
                            <span className={styles.panelTitle}>Partner Profile</span>
                            <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
                                ...
                                <div style={{ minWidth: 0 }}>
                                    ...
                                    <div style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>Platform User</div>
                                </div>
                            </div>
                        </div>

                        <div className={styles.panelSection}>
                            <span className={styles.panelTitle}>Escalation Context</span>
                            <div className={styles.panelCard}>
                                <div style={{ fontSize: '0.88rem', fontWeight: 700, color: 'var(--color-text)' }}>Ticket #1024 — Verification</div>
                                <div style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)', marginTop: '0.15rem' }}>Active Support Case</div>
                                <div style={{ marginTop: '0.6rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <span style={{ fontSize: '0.7rem', color: '#f59e0b', background: '#fffbeb', padding: '2px 8px', borderRadius: '100px', fontWeight: 700 }}>
                                        High Priority
                                    </span>
                                    <span style={{
                                        background: '#eff6ff',
                        ...
                        <div className={styles.panelSection}>
                            <span className={styles.panelTitle}>Moderation Actions</span>
                            <button style={{
                                width: '100%',
                                padding: '0.6rem',
