        ...
        const fetchData = async () => {
            ...
            if (formData.candidate_id) {
                ...
                if (candData) {
                    setFormData(prev => ({
                        ...prev,
                        subject: `Opportunity at TalentMesh: ${candData.full_name}, let's chat!`
                    }));
                }
            }
        };
                ...
                <div className={styles.formCard}>
                    {candidate && (
                        <div className={styles.candidateInfo}>
                            ...
                            <div>
                                <span style={{ fontWeight: 600, display: 'block' }}>{candidate.full_name}</span>
                                <span style={{ fontSize: '0.75rem', color: '#64748b' }}>{candidate.current_role || 'Candidate'}</span>
                            </div>
                        </div>
                    )}
