...
async function main() {
  console.log('--- Applying Database Migration: Claim Export Job RPC Function (ESM) ---');
  
  const sqlPath = path.resolve(__dirname, '../insforge/migrations/013_claim_export_job.sql');
  ...
  try {
    ...
    console.log('✅ Success: claim_export_job RPC function migration applied successfully.');
  } catch (err) {
