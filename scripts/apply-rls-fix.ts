...
async function main() {
  console.log('--- Applying Database RLS Policies Fix ---');
  
  const sqlPath = path.resolve(__dirname, '../fix-job-approval-rls.sql');
  ...
  try {
    ...
    console.log('✅ Success: SQL policies updated successfully in the database.');
  } catch (err: any) {
