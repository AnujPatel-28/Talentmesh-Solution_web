...
- Name: auth.spec.ts >> Authentication Flow >> should redirect unauthenticated users from protected routes
...
Call log:
  - navigating to "http://localhost:3000/dashboard/candidate/some-id", waiting until "load"
