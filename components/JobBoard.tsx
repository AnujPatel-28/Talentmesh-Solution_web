...
const SECTORS = [
    { id: 'tech', label: 'Technology', icon: <Code2 size={24} />, count: '1,240+', color: '#3b82f6' },
    { id: 'design', label: 'Design', icon: <Palette size={24} />, count: '850+', color: '#8b5cf6' },
    { id: 'marketing', label: 'Marketing', icon: <TrendingUp size={24} />, count: '620+', color: '#ec4899' },
    { id: 'finance', label: 'Finance', icon: <Briefcase size={24} />, count: '430+', color: '#10b981' },
    { id: 'health', label: 'Healthcare', icon: <HeartPulse size={24} />, count: '920+', color: '#ef4444' },
    { id: 'business', label: 'Business', icon: <Users size={24} />, count: '310+', color: '#f59e0b' },
    { id: 'education', label: 'Education', icon: <GraduationCap size={24} />, count: '150+', color: '#06b6d4' },
    { id: 'support', label: 'Customer Success', icon: <Headphones size={24} />, count: '280+', color: '#f97316' },
];
