...
// ArrowRight: Used in candidate dashboard, applications page, and layout
...
// Calendar: Used in candidate dashboard, interviews page, and layout
...
// Clock: Used in candidate dashboard, applications page, and interviews page
...
// Check: Used in candidate dashboard, applications page, interviews page, and ResumeManager
...
// External: Used in applications page and interviews page
...
// Eye: Used in candidate dashboard and ResumeManager
...
// Star: Used in candidate dashboard and interviews page
export const Star = ({ filled, ...props }: React.SVGProps<SVGSVGElement> & { filled?: boolean }) => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
    </svg>
);

// User: Used in candidate dashboard and interviews page
...
// ChevronDown: Used in candidate dashboard and interviews page
